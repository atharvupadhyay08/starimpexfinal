...
const ContextMenuSubContent = forwardRef(function ContextMenuSubContent(
  ...
  return (
    <ContextMenuPrimitive.SubContent
      ref={ref}
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md data-[state=open]-in data-[state=closed]-out",
        className
      )}
      {...props}
    />
  ...
  return (
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.Content
        ref={ref}
        className={cn(
          "z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md animate-in fade-in-80 data-[state=open]-in data-[state=closed]-out",
          className
        )}
        {...props}
      />
